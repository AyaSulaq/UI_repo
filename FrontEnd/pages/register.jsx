                        ...
                        <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                            ...
                            <form onSubmit={handleSubmit} className=" space-y-4 md:space-y-6" action="#">
                                <div className='text-left'>
                                    <label htmlFor="fName" className="block mb-2 text-sm font-medium text-indigo-700 dark:text-white">First Name</label>
                                ...
                                <div className='text-left'>
                                    <label htmlFor="lName" className="block mb-2 text-sm font-medium text-indigo-700 dark:text-white">Last Name</label>
